    ...
    <div className="flex w-full min-w-0 flex-col gap-3 bg-white px-4 py-3 sm:px-6 sm:py-4 lg:flex-row lg:items-center lg:justify-between lg:gap-6">
      ...
      <div className="flex w-full min-w-0 flex-col gap-2 sm:flex-row sm:items-stretch sm:justify-end sm:gap-2 lg:w-auto lg:max-w-2xl lg:flex-1 xl:max-w-3xl">
        ...
        <div className="relative min-w-0 flex-1">
          <input id="payment-request-search" type="search" name="q" placeholder="Search by contact or description" className="box-border h-11 min-h-[44px] w-full rounded-lg border border-primary/25 bg-white py-0 pl-3 pr-3 text-base leading-normal text-primary placeholder:text-primary/50 focus:border-secondary focus:outline-none focus:ring-2 focus:ring-secondary/30 sm:h-[42px] sm:min-h-[42px] sm:text-sm" />
        </div>

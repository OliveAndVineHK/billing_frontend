            ...
            {rows.map((row) => (
              ...
              >
                <div className="flex items-center gap-2 sm:contents">
                  <span className="inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-sky-100 text-sky-600" aria-hidden>
                ...
                <div className="flex min-w-0 items-center justify-between gap-2 sm:justify-end">
                  <Link href="#" className="min-w-0 truncate text-sm font-medium text-sky-600 underline underline-offset-2 hover:text-sky-700">
                    {row.invoiceNo}
                  </Link>
                  <button
                    type="button"
